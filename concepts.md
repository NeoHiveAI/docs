...
- **Repo hives** hold indexed source code from a GitHub or GitLab repository. This is how NeoHive makes your agent aware of your actual codebase — it can search your code by meaning, not just by filename or keyword. See [Indexing Your Codebase](codebase.md) for setup.
...
- **Knowledge hives** are where your agents store and retrieve learned context — conventions, decisions, insights, corrections. A knowledge hive is created automatically when you set up a project. Your agents read from and write to it during normal use without any intervention from you.
...
A memory is a single piece of stored knowledge in a knowledge hive — a convention, a decision, an insight, a rule. Your agent creates and retrieves these automatically as you work. When you tell your agent to remember something, or it discovers something worth keeping, it gets stored as a memory and surfaces in future sessions when relevant.
