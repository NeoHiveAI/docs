...
| **Files** | For Document Indexes: the uploaded files, plus a drop zone to add more. See [Document Indexes](documents.md). |
| **Sync Settings** | For Repo Indexes: the sync schedule, file filters, and sync history. See [Indexing Your Codebase](codebase.md). |
