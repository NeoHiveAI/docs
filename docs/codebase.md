---
description: >-
  Index your GitHub or GitLab repositories so your agent can search your code by
  meaning.
---
...
* Indexing runs on your own hardware. It is fast on any machine and quicker with a GPU (see [GPU vs CPU](configuration/gpu.md)).
