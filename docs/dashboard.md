---
description: >-
  A tour of the NeoHive web dashboard: projects, hives, and the tools for
  managing them.
---
...
If a project has been idle for a while, NeoHive suspends it to free resources. Opening it wakes it again automatically, with a short loading state while it resumes. See [Access & sharing](configuration/access.md) for how projects are reached over the network.
