---
description: >-
  Install NeoHive, connect your coding agent, and see it working with your
  codebase.
---
...
1.  Open a terminal and run the installer:
    ...
    <div data-gb-custom-block data-tag="hint" data-style="info" class="hint hint-info"><p>You can supply the license and run the install in one command, either as a flag or an environment variable:</p><pre class="language-bash"><code class="lang-bash"># Environment variable
...
2.  Open the dashboard in your browser.
    ...
    NeoHive runs on `localhost:3577`. Open `http://localhost:3577`. If it's running on another machine, use that machine's address instead. See [Access & sharing](configuration/access.md) for running a shared instance for your team.
3.  Create your first project.

    From the dashboard, follow the onboarding flow to create a project and start indexing.

    <div data-gb-custom-block data-tag="hint" data-style="info" class="hint hint-info"><p>Once you create your first hive, NeoHive begins processing its contents in the background. You can carry on with the steps below while it works. What comes next depends on which agent you use.</p></div>
...
* Remember that we always use snake\_case for database column names in this project.
...
<table data-view="cards"><thead><tr><th></th><th></th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td><strong>Core Concepts</strong></td><td>Understand projects, hives, and how knowledge is organized.</td><td><a href="concepts.md">concepts.md</a></td></tr><tr><td><strong>Using NeoHive</strong></td><td>Your day-to-day workflow with your agent.</td><td><a href="usage.md">usage.md</a></td></tr><tr><td><strong>Indexing Your Codebase</strong></td><td>Connect your GitHub or GitLab repositories.</td><td><a href="codebase.md">codebase.md</a></td></tr></tbody></table>
