...
| `types`   | string list | all       | Restrict results to specific [memory types](reference.md#memory-types).       |
...
| `type`       | string      | required | One of the [memory types](reference.md#memory-types).                           |
...
| Variable                        | Purpose                                                                                                                                       |
| ------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| `NEOHIVE_LICENSE_FILE`          | Path to your license file, used during install. See [Licensing](configuration/licensing.md).                                                  |
| `NEOHIVE_ROTATE_LICENSE`        | Set to `1` to rotate to a replacement license during install.                                                                                 |
| `NEOHIVE_BACKEND`               | Force a compute backend: `cpu`, `cuda`, `vulkan`, or `rocm`. See [GPU vs CPU](configuration/gpu.md).                                          |
