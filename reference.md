...
| `/neohive:capture-session-learnings` | Scans the current conversation and stores corrections, conventions, decisions, and insights into NeoHive. Also runs automatically at session end via the plugin hook. |
