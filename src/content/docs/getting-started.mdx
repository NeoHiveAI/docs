...
- [Core Concepts](/concepts/): understand projects, hives, and how knowledge is organized
- [Using NeoHive](/usage/): day-to-day workflow with your agent
- [Indexing Your Codebase](/codebase/): details on connecting repositories
