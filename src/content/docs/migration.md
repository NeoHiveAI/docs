...
- **They're not searchable by meaning.** Your agent reads them top to bottom. It can't selectively pull the one convention that matters for the current task.
...
You don't need to change how you work. Your agent will pull the migrated knowledge from NeoHive the same way it pulls anything else, when it's relevant.
