---
title: "Reference"
description: "The NeoHive plugin's slash commands and what each one does."
---
...
| `/neohive:migrate-memory` | Imports knowledge from `CLAUDE.md`, `AGENTS.md`, `.cursor/rules`, and `.claude/rules` into NeoHive. See [Migrating from CLAUDE.md](/migration/). |
